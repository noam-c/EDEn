...
class TileEngineOverlay final
{
   ...
   public:
       ...
       */
      TileEngineOverlay(messaging::MessagePipe& messagePipe, PlayerData& playerData, Metadata& metadata, GameStateType stateType, Rml::Core::Context& rocketContext, DialogueController& dialogueController);
