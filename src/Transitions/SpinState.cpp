...
SpinState::SpinState(GameContext& gameContext, GameState* oldState, long transitionLength) :
   TransitionState(gameContext, "SpinState", oldState, NULL, transitionLength)
{
}
